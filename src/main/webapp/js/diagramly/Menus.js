    ...
    Menus.prototype.init = function () {
                        ...
                        editorUi.showDialog(dlg.container, 620, 420, true, false, function (cancel, isEsc) {
                            if (isEsc) {
                                ...
                                if (dlg.graph.container.parentNode != null) {
                                    dlg.graph.container.parentNode.removeChild(dlg.graph.container);
                                }
        ...
        this.put('view', new Menu(mxUtils.bind(this, function (menu, parent) {
            if (Editor.currentTheme == 'simple') {
                ...
                this.addMenuItems(menu, (['format', 'outline', 'layers', 'tags', 'chatWindowTitle']).concat((editorUi.commentsSupported()) ?
                    ['comments', '-'] : ['-']));
